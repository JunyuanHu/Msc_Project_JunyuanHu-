...
#sys.path.extend(['../'])
sys.path.extend(['D:\Project\PyCharmP\STGAT-main\STGAT-main'])
import shutil
import time
import json
import torch
...
with TimerBlock("Good Luck") as block:
    ...
    for epoch in process:
        ...
        global_step, mean_loss = train_net(data_loader_train, model, loss_function, optimizer, global_step, args,
                                            train_writer)
