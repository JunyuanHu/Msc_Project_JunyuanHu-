...
class STAttentionBlock(nn.Module):
    def __init__(self, in_channels, out_channels, inter_channels, num_subset=8, num_node=40, num_frame=32,
        ...
        if use_spatial_att:
            ...
            if att_s:
                ...
                if self.num_node == 18: # Kinetics series
                    from kinetics import AdjMatrixGraph
                elif self.num_node == 40: # NTU RGB+D series
...
class DSTANet(nn.Module):
    def __init__(self, num_class=60, num_point=40, num_frame=32, num_subset=3, dropout=0., config=None, num_person=2,
