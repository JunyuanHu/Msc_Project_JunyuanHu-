...
def parser_args(block):
    ...
    parser.add_argument('-config', default='D:/Project/PyCharmP/STGAT-main_JunyuanGai/STGAT-main/train_val_test/config/ntu/ntu60_dsta.yaml')
